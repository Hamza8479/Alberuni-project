        ...
        <>
            <nav class="navbar sticky-top navbar-light bg-light">
                <div class="container-fluid w-50">
                    ...
                    <div class="col-sm-10">
                        <input value={keyword}
                            onChange={handleSearchChange} type="text" class="form-control" id="search-user" placeholder="Enter a name" />
                    </div>
                </div>
            </nav>
                        ...
                        {data.filter(searched(keyword)).map((c, i) => (
                            <>
                                <tr id={c.firstName} key={i}>
                                    ...
                                    <td>{c.lastName}</td>
                                    <td>User</td>
                                    <td /><button onClick={handleRemove} type="button" class="btn btn-outline-danger btn-sm">Delete</button>
